...
function Header() {
    const useUserData = () => {
        ...
        if (!contextValue) {
          throw new Error(
            "useUserData must be used within a Context.Provider"
          );
        }
        return contextValue;
      };
    ...
    return (
        <Navbar collapseOnSelect bg="light" variant="light">
            <div className="container">
                <Navbar.Brand>
                    <NavLink className="navbar-brand" to="/">GoShop</NavLink>
                </Navbar.Brand>
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    ...
                    {userData ?
                        (<Nav>
                            ...
                            <NavDropdown title={<img id="navImg" src={userData.avatar} alt="user-avatar"/>} drop="start" id="collasible-nav-dropdown">
